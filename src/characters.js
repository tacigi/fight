export const CHARACTERS = {
  ...
  fufu: {
    ...
    moves: {
      ...
      special: {
        ...
        hitbox: { x: 60, y: -90, w: 60, h: 60 }, // klon dari belakang
      },
      ultimate: {
        name: '19 Juta Lapangan Kerja', type: 'ultimate',
  ...
  ganjarist: {
    ...
    moves: {
      ...
      ultimate: {
        name: 'Lari Maraton Tanpa Henti', type: 'ultimate',
